  ...
  return (
    <>
      ...
      <article className="content-html flex flex-col gap-4 pb-8 lg:pt-0 pt-8">
        <Title>Bölüm 1: TypeScript'e Giriş: Temeller ve İlk Uygulama</Title>

        <SubTitle>1.1 TypeScript Nedir?</SubTitle>
        <Text>
          <b>TypeScript</b>, Microsoft tarafından geliştirilen, JavaScript'in
          tüm özelliklerini kapsayan ancak statik tip desteğiyle geliştirilen
          bir üst dildir. Yani:
...
console.log(greet("Yasin"));`}
        ...
        />
        <Text>
          Bu örnekte <code>name: string</code> ve <code>: string</code> dönüş
          tipi ile hem giriş hem çıkış tipi güvence altına alınmış olur.
        </Text>
