...
function Lesson2() {
  ...
  return (
    <article className="content-html flex flex-col gap-4 pb-8 lg:pt-0 pt-8">
      <Title>TypeScript Temel Tipler: string, array, enum ve daha fazlası</Title>

      <SubTitle>2.1 Temel Tipler Nedir?</SubTitle>
      <Text>
        TypeScript, JavaScript’in tüm değer türlerini statik tiplerle tanımlamamıza
        olanak tanır. Bu, kodun hataya daha az açık olmasını sağlar.
      </Text>

      <Text><b>Temel Veri Tipleri:</b></Text>
      <table className="text-sm w-full border border-gray-300 dark:border-gray-700">
        ...
        <tbody>
          ...
          <tr className="even:bg-gray-50 dark:even:bg-gray-900">
            ...
            <td className="p-2">function fail(): never {'{'} throw ... {'}'}</td>
          </tr>
        </tbody>
      </table>
...
const numbersAlt: Array<number> = [1, 2, 3];`}
      ...
      <Text><b>Tuple:</b> Sıralı, sabit uzunlukta farklı türlerden dizi</Text>
      <CodeBlockUI
...
const role: UserRole = UserRole.Admin;`}
        language="ts"
      />
      <Text>✅ Özellikle UI’de rol, durum, tema gibi sabitler için kullanılır.</Text>
...
if (typeof val === "string") {
  console.log(val.toUpperCase()); // Güvenli
      ...
      <Text><b>void:</b> Geriye değer döndürmeyen fonksiyon</Text>
      <CodeBlockUI
  ...
  console.log(msg);
      ...
      <Text><b>never:</b> Fonksiyon hiçbir zaman tamamlanmaz</Text>
      <CodeBlockUI
  ...
  return (
    ...
    />
      ...
      <ul className={textColorClass}>
        <li>Kendi adını, yaşını, premium durumunu ve hobilerini alan bir bileşen oluştur</li>
        <li>Hobileri boş dizi olarak ver</li>
        <li><code>age</code> değerini <code>string</code> olarak ver ve TypeScript hatasını gözlemle</li>
        <li><code>interests: string[] | undefined</code> yaparak opsiyonel hale getir</li>
      </ul>
