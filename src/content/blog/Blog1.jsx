    ...
    <>
      ...
      <article className="content-html flex flex-col gap-4 pb-8 lg:pt-0 pt-8">
        ...
        <ol className={textColorClass}>
          ...
          <li>
            FTP hesabınızın kök dizinini, sitenizin dosyalarının bulunacağı
            dizine ayarlayın. (<code>public_html</code> veya{" "}
            <code>domain.com</code>).
          </li>
          <li>
            FTP hesabınızı oluşturun ve <strong>FTP Hesapları</strong>{" "}
            listesinde oluşturduğunuz ftp hesabı için{" "}
        ...
        <Text>
          FTP kullanıcı adınızı parolanızı ve ftp sunucunuzu GitHub Secrets
          olarak tanımlamanız gerekiyor. Bu işlem, site dosyalarınızın güvenli
          bir şekilde FTP sunucusuna bağlanmasını sağlar.
        </Text>
        ...
        <ul className={textColorClass}>
          ...
          <li>
            Aynı şekilde <code>FTP_PASSWORD</code> adında bir secret daha
            ekleyin ve <strong>FTP parolanızı</strong> secret alanına
            yapıştırın.
          </li>
          <li>
            Aynı şekilde <code>FTP_SERVER</code> adında bir secret daha ekleyin
            ve <strong>FTP sunucusunu</strong> secret alanına yapıştırın. Eğer
            bu değeri kullandığınızda deploy sırasında hata alıyorsanız cPanel'e
        ...
        <Text>
          ...
          projenizi cPanele deploy etmek istiyorsanız projenizin deploy
          sırasında build alınması gerekmektedir. Bu işlem için{" "}
          <code>deploy.yml</code> dosyanızı aşağıdaki gibi güncelleyebilirsiniz.
        </Text>
        ...
        <Text>
          ...
          sitenizi otomatik olarak cPanel'deki FTP sunucunuza yükleyecektir.
          Bunun çalıştığından emin olmak için basit bir test yapabilirsiniz.
        </Text>
        ...
        <Text>
          Başarılı bir işlemde, sitenizin FTP sunucusundaki dosyaları
          güncellenmiş olmalıdır.
        </Text>

        <SubTitle>Sonuç</SubTitle>

        <Text>
          Bu adımları takip ederek, FTP üzerinden GitHub Actions kullanarak
          cPanel üzerinde otomatik dağıtım yapabilirsiniz. Bu süreç, manuel
