export const languagesTexts = {
  0: {
    ...
    SKILLS: "Yetenekler",
    MY_SKILLS: "Yeteneklerim",
    SOCIAL: "Sosyal Medya",
    CV_TEXT: "Özgeçmişimi kendi geliştirdiğim sistem ile hazırladım :)",
    WHAT_I_USED: "Bu Proje İçin Ne Kullandım?",
    WHAT_I_USED_DESC:
  ...
  1: {
    ...
    MY_SKILLS: "My Skills",
    SOCIAL: "Social",
    CV_TEXT: "I prepared my resume with the system I developed myself :)",
    WHAT_I_USED: "What I Used in this Project?",
    WHAT_I_USED_DESC:
